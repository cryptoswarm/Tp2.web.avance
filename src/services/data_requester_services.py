...
from src.helpers.helper import split_and_join
from src.services.arron_service import (
    get_arr_by_name,
    add_arrondissement,
    create_temp_arrondissement,
)
from src.services.patinoire_service import get_patinoire_by_name, add_patinoire
from src.services.pat_conditions_service import add_pat_condition
from src.services.coordinate_service import (
    construct_aqua_position,
    get_position_by_hash,
    add_installation_pos,
)
from src.services.aquatique_inst_services import (
    construct_new_inst_aquatique,
    get_aqua_inst_by_hash,
    add_installation_aquatique,
)
from src.services.glissade_services import (
    create_temp_glissade,
    get_glissade_by_name,
    add_glissade,
)
...
def create_pat_and_conditions(request_response):
    ...
    try:
        ...
        """root is a list of all arrondissements"""
        for child in root:
            ...
            for children in patinoire_elem:
                if children.tag == "nom_pat":
                    ...
                    patinoire, code = get_patinoire_by_name(nom_pat)
        ...
        logging.ERROR("Parsing list of patinoires : {}".format(err.msg))
        pass
...
def create_aqua_installations(request_response: Response):
    ...
    try:
        ...
        logging.ERROR("Parsing aqua line {} err {}".format(reader.line_num, e))
        pass
